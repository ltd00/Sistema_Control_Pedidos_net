<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="FormListaPedido, App_Web_xrmuxvno" %>
                    ...
                    <td>
                        <div>
                            <asp:GridView ID="gvBandeja" SkinID="Principal" runat="server" AutoGenerateColumns="False"
                                ...
                                ShowHeaderWhenEmpty="True" AllowPaging="True" OnRowDataBound="gvBandeja_RowDataBound">
