<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="FormListaPedidoAproba1, App_Web_xrmuxvno" %>
                    ...
                    <td>
                        <div>
                            <asp:GridView ID="gvBandeja" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                ShowFooter="false" ShowHeaderWhenEmpty="true" SkinID="Principal" Width="100%">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Operaciones" ItemStyle-HorizontalAlign="Center">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkSeguimiento" runat="server" CommandArgument='<%# Eval("In60numped") %>'
