<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="PedidoRegistro, App_Web_xrmuxvno" %>
                            ...
                            <asp:GridView ID="gvBandeja" SkinID="Principal" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Descripción de Artículo">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblIn60desart" runat="server" Text='<%# Bind("In60desart") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="GrdHeader" />
                                    </asp:TemplateField>
