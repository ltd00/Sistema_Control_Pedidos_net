<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FormPedidoAproba1.aspx.cs"
    Inherits="FormPedidoAproba1" %>
                    ...
                    <td>
                        <table width="100%" class="table-border-bottom">
                            ...
                            <tr>
                                ...
                                <td>
                                    &nbsp;
                                    <asp:HiddenField ID="hidFlujopedido" runat="server" 
                                        onvaluechanged="hidSituacion_ValueChanged" />
                                </td>
