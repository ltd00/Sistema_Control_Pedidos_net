...
public class UIPage : System.Web.UI.Page
{
    ...
    public AreaBLL oAreaBLL = new AreaBLL();
    public ResponsableBLL oResponsableBLL = new ResponsableBLL();
    public EquipoBLL GEquipoBLL = new EquipoBLL();
    public PeriodoBll oPeriodoBll = new PeriodoBll();
    #endregion
